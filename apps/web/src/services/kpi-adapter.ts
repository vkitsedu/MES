 ...
 */
export function generateShiftBriefingText(kpis: ManagerKpisState, facilityName = 'i-MES 2.0 • SMT FACILITY'): string {
...
${stoppagesStr}
--------------------------------------------------
_Generated by i-MES 2.0 (Fuji Nexim 2.2 / i-MES Gateway)_`;
}
